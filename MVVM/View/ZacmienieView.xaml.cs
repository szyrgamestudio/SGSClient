...
namespace SGSClient.MVVM.View
{
    ...
    public partial class ZacmienieView : UserControl
    {
        ...
        public ZacmienieView() //powoduje wyswietlenia okna w launcherze
        {
            InitializeComponent();
        ...
        private void CheckForUpdates()
        {
            ...
            if (File.Exists(versionFile))
            {
                ...
                try
                {
                    ...
                    WebClient webClient = new WebClient();
                    Version onlineVersion = new Version(webClient.DownloadString("https://www.googleapis.com/drive/v3/files/1iwnla_-k9vTOthknlGT5T6SMvym0txHS?alt=media&key=AIzaSyDh9_ofiUto8RWUDL2CwClUBbRNWHd3Yp4"));  //wersja gry
        ...
        private void InstallGameFiles(bool _isUpdate, Version _onlineVersion)
        {
            try
            {
                ...
                else
                {
                    ...
                    _onlineVersion = new Version(webClient.DownloadString("https://www.googleapis.com/drive/v3/files/1iwnla_-k9vTOthknlGT5T6SMvym0txHS?alt=media&key=AIzaSyDh9_ofiUto8RWUDL2CwClUBbRNWHd3Yp4")); //wersja gry
                }

                webClient.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadGameCompletedCallback);
                webClient.DownloadFileAsync(new Uri("https://www.googleapis.com/drive/v3/files/1YegEuZS92AFHVRT6PealUfcF1F8Bsj5t?alt=media&key=AIzaSyDh9_ofiUto8RWUDL2CwClUBbRNWHd3Yp4"), gameZip, _onlineVersion); //zip gry
        ...
        private void uninstallButton(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Odinstalowanie gry będzie skutkowało usunięciem wszystkich plików związanych z grą Zaćmienie. Czy aby na pewno kontynuować? (Upewnij się, że wykonałeś kopię swoich zapisów gry, jeśli natomiast kliknąłeś ten przycisk z powodu niepoprawnego ściągniecia się plików, możesz ten komunikat zignorować.)", "UWAGA!", MessageBoxButton.YesNo, MessageBoxImage.Warning) == MessageBoxResult.No)
                {
                    //jeśli nie to:
                }
                else
                {
                    ...
                    File.Delete(gameZip);
                    MessageBox.Show($"Pomyślnie usunieto: Zaćmienie", "SGSClient", MessageBoxButton.OK, MessageBoxImage.Information);
