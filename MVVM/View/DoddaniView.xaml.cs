...
namespace SGSClient.MVVM.View
{
    ...
    public partial class DoddaniView : UserControl
    {
        ...
        public DoddaniView() //powoduje wyswietlenia okna w launcherze
        {
            InitializeComponent();
        ...
        private void CheckForUpdates()
        {
            ...
            if (File.Exists(versionFile))
            {
                ...
                try
                {
                    ...
                    WebClient webClient = new WebClient();
                    Version onlineVersion = new Version(webClient.DownloadString("https://drive.google.com/uc?export=download&id=1vgPqhnKLny58SpFm8-bPZ8tzkeFmat7z")); //PLIK WERSJA GRY
        ...
        private void InstallGameFiles(bool _isUpdate, Version _onlineVersion)
        {
            try
            {
                ...
                else
                {
                    ...
                    _onlineVersion = new Version(webClient.DownloadString("https://drive.google.com/uc?export=download&id=1vgPqhnKLny58SpFm8-bPZ8tzkeFmat7z")); //PLIK WERSJA GRY
                }

                webClient.DownloadFileCompleted += new AsyncCompletedEventHandler(DownloadGameCompletedCallback);
                webClient.DownloadFileAsync(new Uri("https://www.googleapis.com/drive/v3/files/13FfocCZSLXK2qiTJS9hjNEt4FCa_C_3j?alt=media&key=AIzaSyDh9_ofiUto8RWUDL2CwClUBbRNWHd3Yp4"), gameZip, _onlineVersion); //PLIK ZIP GRY
        ...
        private void updateClickButton(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                WebClient webClient = new WebClient();
                Version onlineVersion = new Version(webClient.DownloadString("https://drive.google.com/uc?export=download&id=1vgPqhnKLny58SpFm8-bPZ8tzkeFmat7z")); //PLIK WERSJI GRY
        ...
        private void uninstallButton(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (MessageBox.Show("Odinstalowanie gry będzie skutkowało usunięciem wszystkich plików związanych z Doddani. Czy aby na pewno kontynuować? (Upewnij się, że wykonałeś kopię swoich zapisów gry, jeśli natomiast kliknąłeś ten przycisk z powodu niepoprawnego ściągniecia się plików, możesz ten komunikat zignorować.)", "UWAGA!", MessageBoxButton.YesNo, MessageBoxImage.Warning) == MessageBoxResult.No)
                {
                    //jeśli nie to:
                }
                else
