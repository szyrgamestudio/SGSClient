...
namespace SGSClient.Views
{
    public sealed partial class DoddaniPage : Page
    {
        ...
        private readonly string gameZipLink = "https://www.googleapis.com/drive/v3/files/13FfocCZSLXK2qiTJS9hjNEt4FCa_C_3j?alt=media&key=AIzaSyDh9_ofiUto8RWUDL2CwClUBbRNWHd3Yp4";
        private readonly string gameVersionLink = "https://drive.google.com/uc?export=download&id=1vgPqhnKLny58SpFm8-bPZ8tzkeFmat7z";
        ...
        public DoddaniViewModel ViewModel { get; }
        public DoddaniPage()
        {
        ...
        private void PlayClickButton(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (File.Exists(gameExe))
            {
                try
                {
                    ...
                    {
                        WorkingDirectory = Path.Combine(rootPath, "Doddani")
                    };
