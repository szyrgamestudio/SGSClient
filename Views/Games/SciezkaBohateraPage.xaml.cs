...
{
    public sealed partial class SciezkaBohateraPage : Page
    {
        ...
        private readonly string gameZipLink = "https://onedrive.live.com/download?cid=6B420D3CABAB13DF&resid=6B420D3CABAB13DF%211263539&authkey=AMktC0hJdOJYd6Y";
        private readonly string gameVersionLink = "https://onedrive.live.com/download?cid=6B420D3CABAB13DF&resid=6B420D3CABAB13DF%211263538&authkey=AFEzPuVOpaku16g";
        ...
        public SciezkaBohateraViewModel ViewModel { get; }
        public SciezkaBohateraPage()
        {
            ViewModel = App.GetService<SciezkaBohateraViewModel>();
            InitializeComponent();
            ...
            versionFile = Path.Combine(rootPath, "versionSB.txt");
        ...
        private async void InstallGameFiles(bool _isUpdate, SGSVersion.Version _onlineVersion)
        {
            try
            {
                ...
                Status = LauncherStatus.ready;
                App.GetService<IAppNotificationService>().Show(string.Format("SciezkaBohateraNotificationPayload".GetLocalized(), AppContext.BaseDirectory));
            }
            catch (Exception ex)
            {
        ...
        private void PlayClickButton(object sender, Microsoft.UI.Xaml.RoutedEventArgs e)
        {
            if (File.Exists(gameExe))
            {
                try
                {
                    ...
                    {
                        WorkingDirectory = Path.Combine(rootPath, "SciezkaBohatera")
                    };
