...
{
    /// <summary>
    /// Logika interakcji dla klasy Container.xaml
    /// </summary>
    public partial class Container : INavigationWindow
    {
        ...
        {
            this.version = Properties.Settings.Default.version; // Attach the version string from options
        ...
        {
            if (version == "v2.0.1") updateDialog.IsShown = true;  
        }
        /// <summary>
        ...
        {
            System.Diagnostics.Debug.WriteLine($"DEBUG | WPF UI Navigated to: {sender?.Current ?? null}", "SGSClient");
